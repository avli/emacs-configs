...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:background "#434343" :foreground "white" :height 0.9 :box nil))))
 '(mode-line-inactive ((t (:background "#222222" :foreground "grey42" :height 0.9 :box nil))))
 '(whitespace-newline ((t (:foreground "#393D4E" :weight normal))))
 '(whitespace-space ((t (:foreground "#393D4E"))))
