...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:background "#434343" :foreground "white" :box (:line-width -1 :style released-button)))))
 '(mode-line-inactive ((t (:background "#222222" :foreground "grey42" :box (:line-width -1 :style released-button)))))
